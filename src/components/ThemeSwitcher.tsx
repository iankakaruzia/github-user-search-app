...
export function ThemeSwitcher() {
  ...
  return (
    ...
    >
      <span className='mr-4 block py-2 text-heading4 font-bold uppercase tracking-[2.5px] group-hover:text-gray-700 dark:group-hover:text-blue-200'>
        {currentTheme}
      </span>
      ...
      <svg
        ...
        width='20'
        height='20'
        className='fill-gray-500 group-hover:fill-gray-700 dark:fill-white dark:group-hover:fill-blue-200'
      >
        {currentTheme === 'dark' ? (
